...
public class RandomizerGUI extends javax.swing.JFrame {
	...
	protected RomHandler[] checkHandlers = new RomHandler[] {
			new Gen1RomHandler(), new Gen2RomHandler(), new Gen3RomHandler(),
			new Gen4RomHandler(), new Gen5RomHandler() };
	public static final byte PRESET_FILE_VERSION = 100;
	...
	public void testForRequiredConfigs() {
		String[] required = new String[] { "Advance.tbl", "Generation4.tbl",
				"gen3_offsets.ini", "trainerclasses.txt", "trainernames.txt" };
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(optionsScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 610, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(openROMButton, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(saveROMButton, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(usePresetsButton, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(aboutButton, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(generalOptionsPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(optionsScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE)
                .addContainerGap())
        );
	...
	private String getConfigString() {
		...
		baos.write(makeByteSelected(this.ptRandomFollowEvosRB,
				this.ptRandomTotalRB, this.ptUnchangedRB));
		...
		try {
			...
			writeChecksum(baos, getFileChecksum("config/trainerclasses.txt"));
			writeChecksum(baos, getFileChecksum("config/trainernames.txt"));
		} catch (IOException e) {
		}
	...
	public static String getValidRequiredROMName(String config)
		...
		if (!checkOtherCRC(data, 0, 6, "config/trainerclasses.txt",
				data.length - 8)) {
			JOptionPane
					.showMessageDialog(
							null,
		...
		if (!checkOtherCRC(data, 0, 5, "config/trainernames.txt",
				data.length - 4)) {
			JOptionPane
					.showMessageDialog(
							null,
		...
		int nameLength = data[15] & 0xFF;
		if (data.length != 28 + nameLength) {
			return null; // not valid length
		}
		String name = new String(data, 16, nameLength, "US-ASCII");
		return name;
	}
	...
	private void performRandomization(String filename) {
		...
		if (this.pbsChangesUnchangedRB.isSelected()
			...
			if (romHandler instanceof Gen1RomHandler) {
				...
				verboseLog
						.println("NUM|NAME      |TYPE             |  HP| ATK| DEF| SPE|SATK|SDEF");
				for (Pokemon pkmn : allPokes) {
					if (pkmn != null) {
						String typeString = pkmn.primaryType.toString();
						if (pkmn.secondaryType != null) {
						...
						verboseLog.printf(
								"%3d|%-10s|%-17s|%4d|%4d|%4d|%4d|%4d|%4d" + nl,
		...
		if (this.pmsRandomTypeRB.isSelected()) {
			romHandler.randomizeMovesLearnt(true);
		} else if (this.pmsRandomTotalRB.isSelected()) {
			romHandler.randomizeMovesLearnt(false);
		}
		...
		if (this.tnRandomizeCB.isSelected()) {
			romHandler.randomizeTrainerNames();
		}

		if (this.tcnRandomizeCB.isSelected()) {
			romHandler.randomizeTrainerClassNames();
		}
		...
		if (response == JOptionPane.YES_OPTION) {
			try {
				...
				JOptionPane.showMessageDialog(this, "Could not save log file!");
				return;
			}
