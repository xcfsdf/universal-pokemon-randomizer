...
public class PresetMakeDialog extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		setTitle("Randomization Completed - Preset Details");
		setModal(true);
		setResizable(false);

		jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		jLabel1.setText("Your game has been successfully randomized!");

		jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
		jLabel2.setText("Below are the settings you can give to other people to produce the same randomization as you just did.");

		jLabel3.setText("Random Seed:");
		...
		jLabel5.setText("Alternatively you can produce a file which contains this data which you can then send to people.");

		produceFileButton.setText("Produce File");
		produceFileButton
