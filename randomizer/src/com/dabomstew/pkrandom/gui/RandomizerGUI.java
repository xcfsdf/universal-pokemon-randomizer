...
public class RandomizerGUI extends javax.swing.JFrame {
	...
	private void saveROM() {
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			List<String> extensions = new ArrayList<String>(Arrays.asList("gb",
					"gbc", "gba", "nds"));
	...
	public static String getValidRequiredROMName(String config)
		...
		if (!checkOtherCRC(data, 0, 6, "trainerclasses.txt", data.length - 8)) {
			JOptionPane
					.showMessageDialog(
							null,
		...
		if (!checkOtherCRC(data, 0, 5, "trainernames.txt", data.length - 4)) {
			JOptionPane
					.showMessageDialog(
							null,
